...
const LoginPage = () => {
  ...
  const config = {
    androidClientId:
      "322753932012-21no161l0d4gs6a1oc3bhovnkjc1vtr2.apps.googleusercontent.com",
    iosClientId:
      "322753932012-fno0g9kpaq5et8l9d1593bcfd1n54km3.apps.googleusercontent.com",
    webClientId:
      "322753932012-21no161l0d4gs6a1oc3bhovnkjc1vtr2.apps.googleusercontent.com",
  };
        ...
        <View style={globalStyles.loginCard}>
          ...
          <View style={globalStyles.loginSubText}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate("Register")}>
              <Text style={globalStyles.loginRegisterRedirectText}>
                {" "}
                Register Here
              </Text>
            </TouchableOpacity>
