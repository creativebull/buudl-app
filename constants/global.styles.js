...
const globalStyles = StyleSheet.create({
  ...
  horizontalContainerShipping: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
    paddingHorizontal: "3%",
    backgroundColor: "rgba(204,206,109,0.25)",
    paddingTop: 10,
    paddingBottom: 5,
  },
  shippingContainer: {},
  ...
  shippingOptionContainer: {
    backgroundColor: "#CCCE6D",
    padding: 15,
    flexDirection: "row",
    alignItems: "center",
  },
  standardLocal: {
    backgroundColor: "rgba(49,13,0,0.06)",
    paddingVertical: 23,
    paddingHorizontal: 15,
    flexDirection: "row",
    alignItems: "center",
